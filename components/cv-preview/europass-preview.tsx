...
export const EuropassPreview = forwardRef<HTMLDivElement, Props>(
        ...
        >
              ...
              {dp.foto ? (
                ...
                <img
                  ...
                  style={{
                    ...
                    height: "100%",
                    objectFit: "cover",
                    objectPosition: `${50 + dp.fotoOffsetX}% ${50 + dp.fotoOffsetY}%`,
                  }}
                />
              ) : (
                <svg
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
            ...
            {dp.indirizzo && (
              ...
              >
                <MapPin size={10} style={{ flexShrink: 0, opacity: 0.8 }} />
                <span
                  style={{ fontSize: "9.5px", opacity: 0.9, lineHeight: 1.4 }}
                >
                  {dp.indirizzo}
                </span>
              </div>
            ...
            {dp.github && (
              ...
              >
                <Github size={10} style={{ flexShrink: 0, opacity: 0.8 }} />
                <span
                  style={{
                    fontSize: "9.5px",
                    opacity: 0.9,
          ...
          {(dp.dataNascita || dp.luogoNascita || dp.nazionalita) && (
            ...
            >
              ...
              {dp.dataNascita && (
                <div>
                  <span style={{ fontSize: "8.5px", opacity: 0.65 }}>
                    Data di nascita
                  </span>
                  <p
                    style={{ fontSize: "9.5px", margin: "0", fontWeight: 500 }}
                  >
                    {dp.dataNascita}
                  </p>
                </div>
          ...
          {data.altrelingue.length > 0 && (
            <div>
              ...
              <p style={{ fontSize: "8px", color: "#888", marginTop: "3px" }}>
                Livelli: A1/A2 – Elementare · B1/B2 – Intermedio · C1/C2 –
                Avanzato (Quadro comune europeo di riferimento per le lingue)
              </p>
            </div>
          )}
                ...
                <div style={{ minWidth: "140px" }}>
                  ...
                  <p style={{ margin: 0, fontSize: "10.5px", fontWeight: 500 }}>
                    {[
                      data.firma.luogo,
                      data.firma.data
                        ? new Date(data.firma.data).toLocaleDateString(
                          "it-IT",
                          {
                            day: "2-digit",
                            month: "2-digit",
